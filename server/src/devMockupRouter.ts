 ...
 * 2026-07-25 Keita 指示（MC-342）:「もっと市場にインパクトのあるようなアイデアにして」——
 * MC-341 の個人の困りごと解決から、事業として成立しうる・市場を動かしうる切り口へ再刷新。 */
const IDEA_SEEDS = [
  '高額な専門サービスの民主化（弁護士・税理士・コンサル・デザイナー級の仕事を誰でも数百円で）',
  '既存業界の非効率の破壊（不動産仲介・保険営業・人材紹介・中古売買など、中間コストが大きい業界の中抜き）',
  '中小企業・個人事業主のDX（見積書・請求書・在庫・シフト・集客など、まだExcelと紙で回っている業務）',
  '人手不足産業の省人化（介護・物流・飲食・建設・農業の記録/報告/引き継ぎ業務をAIが肩代わり）',
  'クリエイターエコノミーの増幅（個人が作る・売る・ファンを持つまでの障壁をAIで一気に下げる）',
  '教育・リスキリングの個別最適化（一人ひとりの理解度に合わせた教材・演習・フィードバックの自動生成）',
  'ヘルスケア・予防領域の入り口（受診前の症状整理、健診結果のかみ砕き、生活習慣の行動変容支援）',
  'インバウンド・越境の言語障壁の解消（多言語接客・海外販売・海外情報収集を個人や小規模店でも）',
  '高齢化社会のインフラ（相続・終活・見守り・デジタル遺品など、これから需要が急増する領域）',
  'BtoBの隠れた定型業務の自動化（営業提案書・稟議書・監査対応・コンプラチェックの下書きAI）',
  '検索では解決しない意思決定の支援（進路・転職・住宅購入・開業など人生の高額な意思決定のナビ）',
  'データの民主化（企業の決算・行政の統計・不動産価格など公開データを誰でも使える洞察に変換）',
];

/** アイデア生成プロンプトを組む（ランダムな切り口を種に、市場インパクトのある試作品案を 1 つ）。 */
function buildIdeaPrompt(): string {
  ...
  return [
    'あなたは、動く HTML 試作品（モックアップ）を作るためのアイデア出しを手伝う、連続起業家兼ベンチャーキャピタリストです。',
    'テーマは「事業として大きく化けうる・市場に本当にインパクトを与えうるプロダクトの、核となる価値を体験できる試作品」です。',
    '小さな便利ツールではなく「これが広まったら業界や暮らしが変わる」と思わせる事業アイデアの MVP を狙います。',
    'これから「ボタンが実際に動く小さな試作品を 1 つ作る」ための、具体的なアプリ/画面のアイデアを 1 つだけ提案してください。',
    '',
    `今回の切り口（ヒント。これに沿いつつ、より鋭い市場機会に絞ってよい）: ${seed}`,
    '',
    'アイデアが満たすべき条件:',
    '- 大きな市場・強い痛み・お金が動いている領域を突いていること（「あれば嬉しい」ではなく「これに困って皆が金や時間を浪費している」）。',
    '- なぜ今か（AI で初めて可能になった・規制や人口動態の変化・既存プレイヤーの構造的な弱み）が一言で語れること。',
    '- AI の生成力・解析力が競争優位の中心にあり、従来は人手や高額サービスでしか得られなかった価値を安価に出せること。',
    '- 事業の全体像は大きくてよいが、試作品はその核となる価値 1 点に絞り、1 画面＋数個の操作で「刺さる体験」が伝わること。',
    '- 「何を入力して、何のボタンを押すと、何が得られるか」が具体的に分かること（試した人が事業の可能性を確信できる）。',
    '- ありきたりな汎用チャット・要約ツール・既存大手の劣化コピーは避けること（独自の切り口・データ・顧客セグメントを持つこと）。',
    '- 医療・法律・税務は「専門家の代替」と断定せず入り口・下ごしらえとして扱い、不安を煽らないこと。',
    '- 日本語で、1〜2 文（最大でも 140 文字程度）。前置き・箇条書き・見出し・引用符は付けず、説明文だけを出力すること。',
    '- 例の形式: 「物件URLを貼って『査定』を押すと、周辺成約データと将来人口から10年後の資産価値と適正価格を判定し、仲介業者の言い値と比べられる——不動産購入の情報格差を崩すセカンドオピニオン」',
    '',
