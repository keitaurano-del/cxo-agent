...
// 毎回違うアイデアになるよう、4 軸ランダム合成＋直近アイデアの反復回避を入れる（MC-360）。
...
function buildIdeaPrompt(): string {
  ...
  return [
    ...
    '',
    `今回の組み合わせ: 舞台=${genba} × レバレッジ=${lever} × 形=${katachi} × 喜ぶ人=${darega}`,
    '（この組み合わせをヒントに。無理筋なら舞台だけ固定して他は柔軟に崩してよい）',
    ...avoid,
    '',
    'アイデアが満たすべき条件:',
    ...
    '  1 文目〜2 文目: アイデア本体（どの実業で、誰が、何を入力して何を押すと、何が起きるか）。',
