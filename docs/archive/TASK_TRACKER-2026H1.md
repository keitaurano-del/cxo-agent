# TASK_TRACKER 完了タスクアーカイブ 2026H1（〜2026-08-01 完了分）

- 正本: `docs/TASK_TRACKER.md`（未完タスク・直近完了分はそちら）
- 本ファイルは完了済み（DONE / CANCELLED）タスクの退避アーカイブ（MC-358 P3）
- 退避日: 2026-08-02（2026-08-02 付の完了行は正本に残置）
- 収録: 完了タスクの表行（元の表ヘッダごと）＋ `###` 詳細セクション（元の記載のまま移動）
