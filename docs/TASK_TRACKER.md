...
| MC-410 | 市区町村単位の数字表示 | 高 | IN_PROGRESS | Son | Keita指示2026-08-22 17:15「市区町村単位では数字出してほしい」。市区町村集計ピンに店舗数を明示＋市区町村の統計(店舗数/料金相場/1店舗あたり人口等)を見られるように |
| MC-411 | 店舗詳細ページの作り込み | 高 | IN_PROGRESS | Son | Keita指示2026-08-22 17:15「店舗詳細はもっと作り込んで」。Googleマップ参考: 営業時間・設備・料金・Google評価/口コミAI要約・経路案内・共有・写真等を整理した詳細シートへ刷新 |
| MC-412 | 「このサイトについて」メニュー | 中 | IN_PROGRESS | Son | Keita指示2026-08-22 17:15。データ出典(OSM/Places等)・更新方針・免責・問い合わせ導線を掲載するAboutページ＋メニュー導線 |
| MC-413 | 全体UIの磨き込み（Googleマップ参考） | 高 | IN_PROGRESS | Son | Keita指示2026-08-22 17:15「全体的にもっとUIを作り込んで。参考はグーグルマップ」。design-craftスキル適用・検索/一覧/詳細/ランキング/シミュレーションの一貫したUI刷新 |
