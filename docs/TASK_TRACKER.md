...
| MC-392 | マップ上で価格・時間表示（100円で何分） | 高 | IN_PROGRESS | Son | Keita指示2026-08-22 01:32「最初の仕様の通り、マップ上で価格と時間も分かるようにしたい。100円で何分か」。乾燥100円/n分の正規化指標をつくり地図ピン・一覧・並替に反映。チェーン公式の標準料金も収集して適用店を拡大 |
