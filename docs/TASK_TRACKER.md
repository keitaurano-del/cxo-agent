...
| MC-332 | ClipItNow 英語圏向けUX/機能改善の調査 | 高 | IN_PROGRESS（2026-07-22 Keita「英語圏向けにサイトの機能やUIの改善点がないか調査して」）。調査完了（2026-07-22・レポート=video-dl/docs/en-ux-audit-20260722.md）。訪問者の8割がenなのに (a)SSRのtitle/meta/ogが日本語固定 (b)SEOガイド59本が全部日本語 (c)hreflangゼロ＝「英語で集客して日本語を見せる」状態。P1=SSRメタのロケール差し替え・主要ガイドEN化＋hreflang・英文リライト・Pasteボタン。**P1(S)実装をsubagentで実行中（2026-07-22 Son・SSRメタ/ガイドリンク18本i18n/英文リライト/Pasteボタン/hreflang。ガイドEN化(L)は次フェーズ）** | Son | 調査→改善案リスト→実装は別途起票 |
