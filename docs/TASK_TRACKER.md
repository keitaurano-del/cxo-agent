...
| MC-347 | ClipItNow ランキングLP | 中 | IN_PROGRESS（8/7 GSC観測第5回: 28d=11cl/88imp横ばい・日別分解で8/3以降は未確定ラグ・title効果は母数ゼロで判定不能。次=8/9-8/10観測第6回。詳細→ tasks/MC-347.md） | Son | MC-336 / video-dl |
