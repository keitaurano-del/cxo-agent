...
| MC-367 | LBOモデラー機能 | 高 | IN_PROGRESS（8/5 P2先行=実企業プリセット4社を本番反映(f4dd87f)。EDINETライブ連携はAPIキー決裁dec-4b1b2843待ち。詳細→ tasks/MC-367.md） | Son | Keita依頼8/4「アポロでLBOモデルを組めるような機能考えて」。/lbo-mockup.html |
