...
| MC-165 | MC-164 の作り込み：エージェントをドット絵キャラ＋吹き出しで擬人化（現状チープ・誰が誰か不明） | P1 | IN_PROGRESS（2026-06-07 林着手。①@designer(アオイ): 6人格ドット絵アバター作成(レン/ソラ/ケン/ユイ/アオイ/ナオ各1体＋稼働/待機バリエーション)。②@dev-apollo(ソラ): 人格マッピング＋ドット絵+吹き出しSSEリアルタイム UI 実装。並行進捗中） | designer（アオイ）＋dev-apollo（ソラ） |
