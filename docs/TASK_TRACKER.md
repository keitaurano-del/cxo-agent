...
| MC-178 | ダッシュボードに文字サイズ変更機能を追加 | P1 | TODO（2026-06-07 19:18 Keita 依頼・Masayoshi 起票。★スコープKeita確認中=ターミナル(Terminal.tsx L220 text-xs ハードコード)だけか/ダッシュ全体か。確定後 dev-apollo。小/中/大の3段＋永続化が無難） | dev-apollo（ソラ） | スコープ確認待ち |
| MC-179 | ターミナルの C1/C2 アカウント・ドロップダウン削除 | P1 | REVIEW（2026-06-07 19:18 Keita 依頼・Masayoshi 起票。2026-06-07 22:58 林実装→tsc/eslint green→commit 65d5e16。Terminal.tsx L984-996 の account プルダウン/select 削除・バッジ表示のみ化完了。MC-180 と同梱） | dev-apollo（ソラ） / 林実装 | MC-180 と同梱 |
| MC-180 | ターミナルの使用量ベース自動切替機能を削除 | P1 | REVIEW（2026-06-07 19:18 Keita 依頼・Masayoshi 起票。2026-06-07 22:58 林実装→tsc/eslint green→commit 65d5e16。L607-638 の autoSwitchByUsage ロジック＋L945 自動切替廃止。switchAccount 手動経路と整合。MC-179 と同梱） | dev-apollo（ソラ） / 林実装 | MC-179 と同梱 |
