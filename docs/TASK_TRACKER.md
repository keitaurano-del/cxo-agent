...
| MC-370 | Blueairレンタル事業立上げ | 高 | IN_PROGRESS（8/8 11:40 プランv3=2週トライアル/シーズン/スタンダード＋移行ルール(期間短縮不可)確定。モックv3=LP/商品/決済/マイページ4画面化。専用ページ /airrent 新設（仕事タブから転記・独立、サイドメニュー「AirRent」）・本番反映済。残=GO/NO-GO・仕入方針・airrent.jp取得(決済)のKeita判断待ち。詳細→ tasks/MC-370.md） | Son | Keita依頼8/8「Classic Pro特化レンタル、月商10万・極力自動化」。最新情報は /airrent に集約 |
