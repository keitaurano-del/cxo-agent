...
| MC-431 | 地方・全国単位のズームアウト集計表示 | 高 | IN_PROGRESS | Son | Keita指示2026-08-23 00:01「関東、日本単位でズームアウトしたときに数字出して」。z<10の都県合計に加え、より広域で地方(関東等8地方)合計・全国合計の集計ピンを追加 |
| MC-432 | 地図ズームイン/アウトの動作軽量化 | 高 | IN_PROGRESS | Son | Keita指示2026-08-23 00:01「ズームアウト、インするときに動作が重い」。ズーム段階跨ぎの再描画・クラスタ再構築の最適化 |
