...
| MC-426 | Smart Laundry等アプリへの誘導導線 | 高 | IN_PROGRESS | Son | Keita指示2026-08-22 20:32。店舗詳細にSmart Laundry等の公式アプリ/店舗ページへの誘導リンクを追加 |
| MC-427 | オンライン決済・稼働状況対応店の広告風表示 | 高 | IN_PROGRESS | Son | Keita指示2026-08-22 20:32。キャッシュレス/リアルタイム稼働対応店をPR枠風に優先・強調表示（広告商品のショーケース） |
| MC-428 | 広告プラン策定（オーナー/FC/メーカー向け）＋掲載ページ | 高 | IN_PROGRESS | Son | Keita指示2026-08-22 20:32。3セグメント向け広告メニューと料金を設計しサイトに掲載ページ追加 |
| MC-429 | 問い合わせのメール通知（keita.urano@gmail.com） | 高 | IN_PROGRESS | Son | Keita指示2026-08-22 20:32。問い合わせ/オーナー申請等のフォーム送信をResend経由でKeitaへメール通知（jsonl保存は継続） |
| MC-430 | 店舗ライフサイクルデータ蓄積（開業/閉店/稼働履歴） | 高 | IN_PROGRESS | Son | Keita指示2026-08-22 20:32。週次同期の差分から開業/閉店イベントを記録、リアルタイム対応店の稼働率をサンプリング保存。将来の新規出店・需要分析用 |
