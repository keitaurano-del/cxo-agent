...
| MC-370 | Blueairレンタル事業立上げ | 高 | IN_PROGRESS（8/8 需要分析・LPモック・10万円プランv1完成→仕事ページ「Blueairレンタル」タブに集約（/work?tab=blueair・本番反映済）。GO/NO-GO等3点 Keita判断待ち。詳細→ tasks/MC-370.md） | Son | Keita依頼8/8「Classic Pro特化レンタル、月商10万・極力自動化」＋「仕事の独立タブにまとめて」。新規事業 |
