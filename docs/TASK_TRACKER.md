...
| MC-347 | ClipItNow 競合調査→ランキング型LP展開・非アダルト方針（2026-07-25 Keita「まかせるよ。ランキングもアダルト動画ばかりじゃないほうがいい」） | 中 | IN_PROGRESS。Son直接。競合3類型分析（ソフトベンダーSEO/オンラインツール型/アフィリランキング型）→ランキング型が上位主流と判断。第1弾 /twitter-video-save-sites 公開済（自社開示・公式ページ記載ベースの正直比較・非アダルトのみ・本番200・sitemap反映・IndexNow送信済、video-dl commit 8da38de→ランキングcommit）。残: TikTok版・bilibili版ランキングLP、bilibiliクラスタtitle調整（GSC実クエリ反映）。被リンク外部発信は文面を用意してKeita確認後に実施 | Son | MC-336 / video-dl |
