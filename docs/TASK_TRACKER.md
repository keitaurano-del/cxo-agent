...
| MC-401 | 首都圏(神奈川・埼玉・千葉)への店舗データ拡大 | 高 | IN_PROGRESS | Son | Keita指示2026-08-22 14:28「東京だけじゃなくて首都圏のも出せる？」。fetch-osm(JP-13固定)とfetch-gplaces(東京bbox四分木)を1都3県対応に拡張し再sync。チェーン系fetcherの都県フィルタ確認・merge/pricing整合も。Places API追加コスト見込み数百call程度 |
