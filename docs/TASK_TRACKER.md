...
| MC-347 | ClipItNow ランキングLP | 中 | IN_PROGRESS（8/9 観測第6回:【重要】ガイド群が全て『Crawled - currently not indexed』=インデックス落ち・残存はホームのみ・8/3以降imp全日0。対処案4点を今夜のまとめでKeita判断へ。詳細→ tasks/MC-347.md） | Son | MC-336 / video-dl |
