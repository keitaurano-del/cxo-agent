...
| MC-352 | ClipItNow ブログ配信 | 高 | IN_PROGRESS（Tumblr/Blogger/note開設をSon単独試行・CAPTCHA遭遇時は保留。詳細→ tasks/MC-352.md） | Son | 外部投稿はKeita承認済（2026-07-31）。MC-331/351と連動 |
...
| MC-359 | アイデア生成の修理 | 高 | REVIEW（commit b2f634d・実機3回8〜10sでdone確認済。push は Keita 承認待ち。詳細→ tasks/MC-359.md） | dev-apollo | commit b2f634d。fast opts(--tools ''/中立cwd/短system-prompt/思考オフ)＋IDEA_TIMEOUT 90→120s＋シード刷新。実機3回 8〜10s で done・毎回別案・市場規模文あり。push は Keita 承認待ち |
