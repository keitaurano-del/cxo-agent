...
// MC-317: /agents-live はタスクボードのタブへ移動したため除外。/revenue はダッシュのタブ。/pdca は ClipItNow PDCA 停止で削除（2026-09-05 Keita）。
const DASHBOARD_PREFIXES = ['/', '/countdown', '/feed', '/agents', '/activity', '/plan-usage', '/news', '/revenue'];
